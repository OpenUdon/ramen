...
variable "cluster_role_binding_name" {
  type    = string
  default = "ramen-parity-k12-cluster-role-binding"
}

variable "cluster_role_name" {
  type    = string
  default = "ramen-parity-k12-cluster-role"
}

variable "service_account_name" {
  type    = string
  default = "ramen-parity-k12-service-account"
}

variable "service_account_namespace" {
  type    = string
  default = "ramen-parity-k12-subjects"
}
...
resource "kubernetes_cluster_role_binding_v1" "k12_cluster_role_binding" {
  metadata {
