...
| C03 | Cloudflare R2 metadata variants | Opt-in live runner added; recording deferred. | HCL, focused OpenAPI, and native create/read/update/delete fixture are committed and replayed. | Validates; role and operation set matches. | Promote a sanitized metadata-mutability recording after explicit review. |
| C04 | Cloudflare D1 database create/read | Opt-in live runner added; current local smoke blocked by D1 token HTTP 401; recording deferred. | HCL, focused OpenAPI, and native create/read fixture are committed and replayed with direct delete cleanup. | Validates; role and operation set matches. | Retry with a Cloudflare token that can list/create/delete D1 databases, then promote a sanitized recording after review. |
| C05 | Cloudflare D1 UUID/delete unlock | Opt-in live runner added; current local smoke blocked by D1 token HTTP 401; recording deferred. | HCL, focused OpenAPI, and native create/read/delete fixture are committed and replayed. | Validates; role and operation set matches. | Retry with a Cloudflare token that can list/create/delete D1 databases; D1 update remains unclaimed. |
