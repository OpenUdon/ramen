...
func CatalogV1() Catalog {
	entries := []Entry{
		...
		{Code: "apply.baseline_drift", Severity: "error", Meaning: "Apply read-before-write found remote drift from the approved state baseline.", LikelyCause: "The remote object changed after the reviewed plan or current Ramen state is stale.", Repair: "Run refresh, review the new plan, and approve the updated baseline before applying."},
		{Code: "apply.baseline_exists", Severity: "error", Meaning: "Apply read-before-write found an existing remote object for a planned create.", LikelyCause: "The object already exists remotely or local state does not track it.", Repair: "Import or refresh the object, rename the desired resource, or review the create plan again."},
		{Code: "apply.baseline_failed", Severity: "error", Meaning: "Apply could not complete the read-before-write baseline check.", LikelyCause: "The trusted executor could not read the remote object before mutation.", Repair: "Inspect executor feedback and retry after correcting read access or mapping metadata."},
		{Code: "apply.baseline_missing", Severity: "error", Meaning: "Apply read-before-write could not find a remote object for a planned update.", LikelyCause: "The object was deleted remotely or local state is stale.", Repair: "Run refresh, review the new plan, and approve the corrected action."},
		{Code: "apply.convergence_failed", Severity: "error", Meaning: "Apply could not complete the read-after-write convergence check.", LikelyCause: "The trusted executor could not read the object after mutation.", Repair: "Inspect executor feedback and remote state before retrying."},
		{Code: "apply.convergence_missing", Severity: "error", Meaning: "Apply read-after-write reported the object missing after mutation.", LikelyCause: "The mutation did not create/update the expected object or the read identity is wrong.", Repair: "Inspect executor output, mapping metadata, and remote state before retrying."},
		...
		{Code: "apply.settle_failed", Severity: "error", Meaning: "Apply could not complete the configured pre-mutation settle barrier.", LikelyCause: "A read during the settle window failed, reported the object missing, or the run was canceled.", Repair: "Inspect executor feedback, wait for the remote API lock or consistency window to clear, and retry the approved plan if still valid."},
		...
		{Code: "import.read_document_invalid", Severity: "error", Meaning: "Ramen could not build an import read-verification document.", LikelyCause: "The read operation mapping, source path, or identity binding metadata is incomplete.", Repair: "Fix the native project read metadata before verifying import reads."},
		{Code: "import.read_failed", Severity: "error", Meaning: "Import read verification failed.", LikelyCause: "The trusted executor could not read the remote object during import verification.", Repair: "Inspect executor feedback, identity input, and read metadata before retrying."},
		{Code: "import.read_mismatch", Severity: "error", Meaning: "Import read verification returned identity that does not match the supplied identity.", LikelyCause: "The supplied identity points at a different remote object or response binding metadata is wrong.", Repair: "Correct the identity input or mapping metadata before importing."},
		{Code: "import.read_missing", Severity: "error", Meaning: "Import read verification reported the remote object missing.", LikelyCause: "The supplied identity does not identify an existing object or the read operation is scoped incorrectly.", Repair: "Correct the identity input or create the object before importing."},
		{Code: "import.read_unsupported", Severity: "error", Meaning: "The selected executor cannot perform import read verification.", LikelyCause: "The executor lacks the protocol or output capabilities required by the read action.", Repair: "Select an executor with read/output/missing-evidence support or import without read verification."},
		...
		{Code: "validate.settle_invalid", Severity: "error", Meaning: "A native resource has an unsupported settle runtime hint.", LikelyCause: "The settle hint uses an unsupported phase, predicate, or non-positive duration/interval.", Repair: "Use a positive pre-delete settle hint with read_expect exists, or remove the hint."},
		{Code: "validate.settle_read_role_missing", Severity: "error", Meaning: "A settle runtime hint requires read operation metadata.", LikelyCause: "Ramen cannot run the read-backed settle barrier because the resource has no read role.", Repair: "Add read operation metadata or remove the settle hint."},
